...
## Flujo
1. Leer `agents.md`.
2. Revisar primero `agents.md`, el rol o skill aplicable y, cuando se necesite contexto documental del proyecto, consultar la boveda externa de SIGQUA.
   No crear documentacion de proyecto dentro del repositorio.
...
4. Si el plan, alcance o diseno tiene decisiones abiertas, usar `interrogar` o `grill-with-docs` antes de implementar:
   ...
   - `grill-with-docs` cuando la conversacion deba contrastarse con documentacion vigente de la boveda externa.
...
8. Si hubo investigacion externa o una decision reutilizable, persistir el aprendizaje en la skill, rol o boveda externa solo cuando aporte valor real y no duplique informacion existente.
