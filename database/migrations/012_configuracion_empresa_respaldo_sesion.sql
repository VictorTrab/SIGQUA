...
('respaldo.ruta_principal', './respaldos', 'TEXTO', 'Respaldo', 'Carpeta principal donde SICAP genera los respaldos locales.', 1),
('respaldo.ruta_secundaria', '', 'TEXTO', 'Respaldo', 'Carpeta secundaria opcional para copia adicional de respaldos.', 1),
('respaldo.secundaria_activa', '0', 'BOOLEANO', 'Respaldo', 'Indica si SICAP debe guardar una copia secundaria del respaldo.', 1),
...
('respaldo.retencion_dias', '30', 'ENTERO', 'Respaldo', 'Cantidad de dias a conservar respaldos gestionados por SICAP.', 1),
