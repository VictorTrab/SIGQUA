...
class ServicioReportes:
    ...
    CATALOGO_REPORTES = (
        ...
        TarjetaReporte(
            ...
            descripcion="Deuda pendiente agrupada por mes de cobro.",
            icono="calendar-dollar.svg",
            resumen="Pendiente por periodo",
        ),
        TarjetaReporte(
            codigo=REPORTE_DEUDA_POR_CASA,
            titulo="Deuda pendiente por casa",
            descripcion="Saldo pendiente vigente por casa responsable.",
            icono="home-dollar.svg",
            resumen="Saldos por vivienda",
        ),
        TarjetaReporte(
            codigo=REPORTE_CASAS_CORTADAS,
            titulo="Casas cortadas",
            descripcion="Casas con servicio fisicamente cortado.",
            icono="plug-off.svg",
            resumen="Seguimiento de corte",
        ),
        TarjetaReporte(
            codigo=REPORTE_CASAS_SUSPENDIDAS_INACTIVAS,
            titulo="Casas suspendidas o inactivas",
            descripcion="Casas no operativas administrativamente o inactivas.",
            icono="home-off.svg",
            resumen="Estado no operativo",
        ),
        TarjetaReporte(
            codigo=REPORTE_NUEVOS_ABONADOS,
            titulo="Nuevos abonados",
            descripcion="Abonados registrados dentro de un rango de fecha.",
            icono="user-plus.svg",
            resumen="Altas por fecha",
        ),
        TarjetaReporte(
            codigo=REPORTE_PAGOS_POR_USUARIO,
            titulo="Pagos por usuario",
            descripcion="Pagos confirmados agrupables por cajero o usuario cobrador.",
            icono="cash-register.svg",
            resumen="Control de caja",
        ),
    )
